...
export const productsEn: ProductEn[] = [
  ...
  },
  {
    ...
    features: ["12kg portable design", "220V/380V dual voltage auto-detection", "Anti-stick, arc force & hot start", "Generator compatible for field operations"],
  },
  {
    slug: "cut-100",
    ...
    specs: {
      "Input Voltage": "AC 380V ±15%",
      "Rated Input Power": "20 KVA",
      "Cutting Current Range": "20-100 A",
      "Max Cutting Thickness": "SS 30mm / CS 35mm",
      "Rated Duty Cycle": "60%",
      "Protection Class": "IP23",
      "Cooling": "Air / Built-in Pump",
      "Weight": "~35 kg",
    },
